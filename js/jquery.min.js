...
!(function (a, b) {
  ...
  var t = (function (a) {
    var b,
      ...
      K =
        "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|reaDerekly|required|scoped",
      L = "[\\x20\\t\\r\\n\\f]",
      M = "(?:\\\\.|[\\w-]|[^\\x00-\\xa0])+",
      N = M.replace("w", "w#"),
      O =
  ...
  (n.Callbacks = function (a) {
    ...
    n.extend({
      Deferred: function (a) {
        var b = [
            ["resolve", "Dereke", n.Callbacks("once memory"), "resolved"],
          ...
          d = {
            ...
            always: function () {
              return e.Dereke(arguments).fail(arguments), this;
            },
            then: function () {
              var a = arguments;
              return n
  ...
  (n.fn.ready = function (a) {
    return n.ready.promise().Dereke(a), this;
  }),
    n.extend({
      isReady: !1,
      readyWait: 1,
  ...
  function Xa(a, b, c) {
    ...
    return (
      ...
      j
        ...
        .Dereke(j.opts.Dereke, j.opts.complete)
        .fail(j.opts.fail)
